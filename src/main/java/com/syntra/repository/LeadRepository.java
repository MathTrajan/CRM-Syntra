...
public interface LeadRepository extends JpaRepository<Lead, String>, JpaSpecificationExecutor<Lead> {
    ...
    // CAST(:param AS tipo) em TODOS os parametros nullable e' obrigatorio:
    // Hibernate 6 nao envia tipo do bind quando valor e' null e o Postgres
    // infere bytea / "could not determine data type". CAST fixa o tipo do bind.
    @Query("""
